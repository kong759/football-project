...
public class TeamListDTO {
	...
	public String toString() {
		return "TeamListDTO [id=" + id + ", name=" + name + ", logoPath=" + logoPath + ", presentNum=" + presentNum
				+ ", maxNum=" + maxNum + ", uniformColorCode=" + uniformColorCode + ", strengthCode=" + strengthCode
				+ ", location=" + location + ", formation=" + formation + "]";
	}
}
