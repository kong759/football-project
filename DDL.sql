...
COMMENT ON COLUMN GAME_INFO.GAME_DATE IS '게임 날짜';
...
INSERT INTO GAME_INFO(ID,STATUS_CODE,MAX_PERSON_NUM,KIND,GAME_DATE,DURATION,DESCRIPTION,MAXNUM_TEAM)
    VALUES(0,0,0,0,'',0,'',0);
...
CREATE UNIQUE INDEX GAME_LOCATION_PK2 ON GAME_LOCATION
( ID );
...
COMMENT ON COLUMN TEAM_PARTICIPATE.GAME_ID IS '게임 번호';

COMMENT ON COLUMN TEAM_PARTICIPATE.TEAM_ID IS '팀 번호';

COMMENT ON TABLE TEAM_PARTICIPATE IS '참가팀';

CREATE UNIQUE INDEX TEAM_PARTICIPATE_PK8 ON TEAM_PARTICIPATE
( GAME_ID,TEAM_ID );

ALTER TABLE TEAM_PARTICIPATE
 ADD CONSTRAINT TEAM_PARTICIPATE_PK8 PRIMARY KEY ( GAME_ID,TEAM_ID )
...
INSERT INTO TEAM_PARTICIPATE(GAME_ID,TEAM_ID)
    VALUES(0,0);
